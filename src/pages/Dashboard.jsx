								...
								<div className="card-inner">
									...
									<div className="info">
										<span className="change down text-danger">
											<em className="icon ni ni-arrow-long-down" />2.34%
										</span>
										<span> Requests</span>
									</div>
								</div>
								...
								<div className="card-inner">
									...
									<div className="data">
										<div className="data-group">
											...
											<div className="nk-ecwg6-ck">
												<canvas className="ecommerce-line-chart-s3" id="todayOrders" width={100} height={40} style={{ display: 'block', boxSizing: 'border-box', height: 40, width: 100 }} />
											</div>
										</div>
									</div>
									<div className="info">
										<span className="change up">
											<em className="icon ni ni-arrow-long-up" />3.97%
										</span>
										<span> Requests</span>
									</div>
								</div>

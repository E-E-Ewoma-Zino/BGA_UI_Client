						...
						<div className="nk-split nk-split-page nk-split-lg">
							<div className="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white">
								<div className="absolute-top-right d-lg-none p-3 p-sm-5">
									<a href="#x" className="toggle btn-white btn btn-icon btn-light" data-target="athPromo"><em className="icon ni ni-info" /></a>
								</div>
								<div className="nk-block nk-block-middle nk-auth-body">
									...
									{/* .nk-block-head */}
									<form action="#" className="form-validate is-alter" autoComplete="off" noValidate="novalidate">
									...
									<div className="text-center mt-5">
										<span className="fw-500">I don't have an account? <a href="#x">Try 15 days free</a></span>
									</div>
								</div>
								{/* .nk-block */}
